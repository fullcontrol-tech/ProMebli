document.addEventListener('DOMContentLoaded', function () {
    ...
    event.preventDefault(); // ❗️ блокуємо браузерну відправку

    // Telegram
    sendTelegram();

    // FormSubmit (пошта)
    this.submit(); // ❗️ відправляємо вручну після Telegram

    // Facebook Pixel (не обов'язково)
    ...
    const botToken = '7861796802:AAGpsK-2udmk4vWjDOnv_ESfKWlhQ6cMUp4';
    const chatId = '-1002694866518';
